...
<template>
<!-- component -->
<footer class="bg-[#646cff] text-white lg:px-24 xl:px-[250px] 2xl:px-[350px] px-8 sm:px-24 md:px-28">
  <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <img src="../assets/shipit.svg" class="mr-5 h-32" alt="logo" />
        ...
        <div class="flex mt-8 space-x-6 text-gray-600">
          <a class="hover:opacity-75" target="_blank" rel="noreferrer">
            ...
            <svg class="w-6 h-6" fill="#fff" viewBox="0 0 24 24" aria-hidden="true">
